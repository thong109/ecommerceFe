<template>
  <header class="app-header align-items-center">
    ...
    <button type="button" @click="toogleButton" class="app-sidebar__toggle m-0"><i class="bi bi-microsoft"></i></button>
    <!-- Navbar Right Menu-->
    <ul class="app-nav justify-content-between">
      <!-- User Menu-->
      <li>
        <router-link to="/" class="app-nav__item m-0 bg-transparent text-white"><i class="bi bi-house"></i>
        </router-link>
      </li>
      <li>
        <button type="button" @click="logout" class="app-nav__item m-0"><i class="bi bi-box-arrow-right"></i>
        </button>
      </li>
    </ul>
  </header>
...
.app-menu__item.router-link-exact-active,
